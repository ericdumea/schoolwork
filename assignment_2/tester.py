...
A2_DATA = ""
A2_PROG = "a2"
...
def checkThreads3(data, infos):
    ...
    if info1.timeStart > thInfos[thBefore].timeEnd:
        ...
        errors.append("thread T%d.%d starts after T%d.%d" % (proc1, proc1Th, procNr, thBefore))
    if info1.timeEnd < thInfos[thAfter].timeStart:
        score += 1
    else:
        errors.append("thread T%d.%d ends before T%d.%d" % (proc1, proc1Th, procNr, thBefore))
    if score == 3:
        score = 5
