...
A3_DATA = ""
A3_PROG = "a3"
...
class Tester(threading.Thread):
    ...
    def test_read_offset(self, fname):
        ...
        #print "That's it: %s" % content
        fin.close()
        readContent = ctypes.string_at(shAddr, 50)
        #print "That's it: %s" % readContent
    ...
    def test_read_section(self, fname):
        ...
        for sectId in sectIds:
            ...
            #print "My res : %s" %readContent
            #print "Expected : %s" %expectedContent
